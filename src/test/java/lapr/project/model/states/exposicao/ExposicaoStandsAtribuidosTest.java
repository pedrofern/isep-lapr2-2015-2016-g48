 ...
 * @author Edu
 */
public class ExposicaoStandsAtribuidosTest {
    ...
    public ExposicaoStandsAtribuidosTest() {
    }
    ...
    /**
     * Test of valida method, of class ExposicaoStandsAtribuidos.
     */
    @Test
    public void testValida() throws Exception {
        ...
        ExposicaoStandsAtribuidos instance = new ExposicaoStandsAtribuidos();
        exp.alterarEstado(new ExposicaoCandidaturasDecididas());
    ...
    /**
     * Test of setExposicaoStandsAtribuidos method, of class ExposicaoStandsAtribuidos.
     */
    @Test
    public void testSetExposicaoStandsAtribuidos() throws Exception {
        ...
        exp.alterarEstado(new ExposicaoCandidaturasDecididas());
        boolean expResult = true;
        boolean result = instance.setExposicaoStandsAtribuidos(exp);
        assertEquals(expResult, result);
    }

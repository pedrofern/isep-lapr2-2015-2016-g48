 ...
 * @author Edu
 */
public class CandidaturaDemoStateTest {
    
    public CandidaturaDemoStateTest() {
    }
    ...
    public void testValida() {
        ...
        CandidaturaDemoState instance = new CandidaturaDemoStateImpl();
    ...
    public class CandidaturaDemoStateImpl implements CandidaturaDemoState {

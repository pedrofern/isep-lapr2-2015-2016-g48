 ...
 */
@XmlRootElement
public class DemonstracaoFechadas extends DemonstracaoEstado implements Serializable{
    /**
    ...
    public boolean valida(Demonstracao demonstracao) {
            ...
            if (state instanceof DemonstracaoEmAberto) {
            return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setDemonstracaoFechadas(Demonstracao demonstracao) {

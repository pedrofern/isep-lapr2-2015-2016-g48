 ...
 */
@XmlRootElement
public class DemonstracaoRegistada extends DemonstracaoEstado implements Serializable{
    /**
    ...
    public boolean valida(Demonstracao demonstracao) {
            ...
            if (state instanceof DemonstracaoCriada) {
            return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setDemonstracaoRegistada(Demonstracao demonstracao) {

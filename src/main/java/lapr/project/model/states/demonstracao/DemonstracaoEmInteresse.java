 ...
 */
@XmlRootElement
public class DemonstracaoEmInteresse extends DemonstracaoEstado implements Serializable{
    /**
    ...
    public boolean valida(Demonstracao demonstracao) {
            ...
            if (state instanceof DemonstracaoRegistada) {
            return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setDemonstracaoEmInteresse(Demonstracao demonstracao) {

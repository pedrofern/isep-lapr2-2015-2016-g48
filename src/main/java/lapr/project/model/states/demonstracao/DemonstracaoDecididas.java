 ...
 */
@XmlRootElement
public class DemonstracaoDecididas extends DemonstracaoEstado implements Serializable{
    /**
    ...
    public boolean valida(Demonstracao demonstracao) {
            ...
            if (state instanceof DemonstracaoEmInteresse) {
            return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setDemonstracaoDecididas(Demonstracao demonstracao) {

 ...
 */
@XmlRootElement
public class ExposicaoConflitosDetetados extends ExposicaoEstado implements Serializable{
    /**
    ...
    public boolean valida(Exposicao exposicao) {
        ...
        if (state instanceof ExposicaoCandidaturasFechadas) {
        return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setExposicaoConflitosDetetados(Exposicao exposicao) {

 ...
 */
@XmlRootElement
public class ExposicaoDemonstracaoSemFAE extends ExposicaoEstado implements Serializable{
    /**
    ...
    public boolean valida(Exposicao exposicao) {
            ...
            if (state instanceof ExposicaoCriada) {
            return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setExposicaoDemonstracaoSemFAE(Exposicao exposicao) {

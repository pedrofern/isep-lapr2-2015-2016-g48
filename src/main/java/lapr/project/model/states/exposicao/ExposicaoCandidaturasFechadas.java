 ...
 */
@XmlRootElement
public class ExposicaoCandidaturasFechadas extends ExposicaoEstado implements Serializable{
    /**
    ...
    public boolean valida(Exposicao exposicao) {
        ...
        if (state instanceof ExposicaoCandidaturasAberta) {
        return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setExposicaoCandidaturasFechadas(Exposicao exposicao) {

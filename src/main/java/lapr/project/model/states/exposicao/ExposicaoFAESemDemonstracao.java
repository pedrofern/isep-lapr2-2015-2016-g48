 ...
 */
@XmlRootElement
public class ExposicaoFAESemDemonstracao extends ExposicaoEstado implements Serializable{
    /**
     ...
     */
    @Override
    public boolean setExposicaoFAESemDemonstracao(Exposicao exposicao) {

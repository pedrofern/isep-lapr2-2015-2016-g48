 ...
 */
@XmlRootElement
public class ExposicaoConflitosAlterados extends ExposicaoEstado implements Serializable{
    /**
    ...
    public boolean valida(Exposicao exposicao) {
        ...
        if (state instanceof ExposicaoConflitosDetetados) {
        return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setExposicaoConflitosAlterados(Exposicao exposicao) {

 ...
 */
@XmlRootElement
public class ExposicaoStandsAtribuidos extends ExposicaoEstado implements Serializable{
    /**
    ...
    public boolean valida(Exposicao exposicao) {
        ...
        if (state instanceof ExposicaoCandidaturasDecididas) {
        return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setExposicaoStandsAtribuidos(Exposicao exposicao) {

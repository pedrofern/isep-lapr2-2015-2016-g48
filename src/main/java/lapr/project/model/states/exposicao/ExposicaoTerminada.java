 ...
 */
@XmlRootElement
public class ExposicaoTerminada extends ExposicaoEstado implements Serializable{
    /**
    ...
    public boolean valida(Exposicao exposicao) {
        ...
        if (state instanceof ExposicaoStandsAtribuidos) {
        return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setExposicaoTerminada(Exposicao exposicao) {

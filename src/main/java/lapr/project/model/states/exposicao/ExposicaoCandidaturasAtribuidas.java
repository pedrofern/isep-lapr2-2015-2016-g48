 ...
 */
@XmlRootElement
public class ExposicaoCandidaturasAtribuidas extends ExposicaoEstado implements Serializable{
    /**
    ...
    public boolean valida(Exposicao exposicao) {
        ...
        if (state instanceof ExposicaoCandidaturasEmAtribuicao) {
        return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setExposicaoCandidaturasAtribuidas(Exposicao exposicao) {

 ...
 */
@XmlRootElement
public class ExposicaoCandidaturasEmAtribuicao extends ExposicaoEstado implements Serializable{
    /**
    ...
    public boolean valida(Exposicao exposicao) {
        ...
        if (state instanceof ExposicaoConflitosAlterados) {
        return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setExposicaoCandidaturasEmAtribuicao(Exposicao exposicao) {

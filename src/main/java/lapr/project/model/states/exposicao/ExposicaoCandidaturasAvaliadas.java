 ...
 */
@XmlRootElement
public class ExposicaoCandidaturasAvaliadas extends ExposicaoEstado implements Serializable{
    /**
    ...
    public boolean valida(Exposicao exposicao) {
        ...
        if (state instanceof ExposicaoCandidaturasAtribuidas) {
        return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setExposicaoCandidaturasAvaliadas(Exposicao exposicao) {

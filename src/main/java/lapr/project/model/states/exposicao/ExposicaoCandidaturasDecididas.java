 ...
 */
@XmlRootElement
public class ExposicaoCandidaturasDecididas extends ExposicaoEstado implements Serializable{
    /**
    ...
    public boolean valida(Exposicao exposicao) {
        ...
        if (state instanceof ExposicaoCandidaturasAvaliadas) {
        return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setExposicaoCandidaturasDecididas(Exposicao exposicao) {

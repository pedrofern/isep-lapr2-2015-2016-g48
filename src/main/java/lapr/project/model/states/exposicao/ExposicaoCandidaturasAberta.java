 ...
 */
@XmlRootElement
public class ExposicaoCandidaturasAberta extends ExposicaoEstado implements Serializable{
    /**
    ...
    public boolean valida(Exposicao exposicao) {
        ...
        if (state instanceof ExposicaoCompleta) {
        return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setExposicaoCandidaturasAberta(Exposicao exposicao) {

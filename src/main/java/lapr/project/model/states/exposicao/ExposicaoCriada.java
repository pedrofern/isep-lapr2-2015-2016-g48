 ...
 */
@XmlRootElement
public class ExposicaoCriada extends ExposicaoEstado implements Serializable{
    /**
    ...
    public boolean valida(Exposicao exposicao) {
        ...
        if (state instanceof ExposicaoEstadoInicial) {
        return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setExposicaoCriada(Exposicao exposicao) {

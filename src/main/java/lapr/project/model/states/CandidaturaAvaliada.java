...
//@XmlTransient
//@XmlSeeAlso({CandidaturaAceite.class, CandidaturaEmAtribuicaoFAE.class,
...
public class CandidaturaAvaliada implements CandidaturaEstado, Serializable{
    
    private final Candidatura candidatura;
    
    public CandidaturaAvaliada(Candidatura candidatura){

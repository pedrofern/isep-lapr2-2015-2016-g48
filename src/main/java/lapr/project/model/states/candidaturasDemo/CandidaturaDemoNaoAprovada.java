 ...
 */
@XmlRootElement
public class CandidaturaDemoNaoAprovada extends CandidaturaDemoEstado implements Serializable {
    /**
    ...
    public boolean valida(CandidaturaDemonstracao candidatura) {
        ...
        if (state instanceof CandidaturaDemoEmInteresse) {
            return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setCandidaturaDemoNaoAprovada(CandidaturaDemonstracao candidatura) {

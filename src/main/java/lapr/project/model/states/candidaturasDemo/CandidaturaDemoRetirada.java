 ...
 */
@XmlRootElement
public class CandidaturaDemoRetirada extends CandidaturaDemoEstado implements Serializable {
    /**
     ...
     */
    @Override
    public boolean setCandidaturaDemoRetirada(CandidaturaDemonstracao candidatura) {

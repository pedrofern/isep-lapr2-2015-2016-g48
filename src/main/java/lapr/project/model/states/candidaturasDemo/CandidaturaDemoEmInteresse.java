 ...
 */
@XmlRootElement
public class CandidaturaDemoEmInteresse extends CandidaturaDemoEstado implements Serializable {
    /**
    ...
    public boolean valida(CandidaturaDemonstracao candidatura) {
        ...
        if (state instanceof CandidaturaDemoCriada) {
            return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setCandidaturaDemoEmInteresse(CandidaturaDemonstracao candidatura) {

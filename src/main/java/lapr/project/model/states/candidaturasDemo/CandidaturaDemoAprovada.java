 ...
 */
@XmlRootElement
public class CandidaturaDemoAprovada extends CandidaturaDemoEstado implements Serializable {
    /**
     ...
     */
    @Override
    public boolean setCandidaturaDemoAprovada(CandidaturaDemonstracao candidatura) {

 ...
 */
@XmlRootElement
public class CandidaturaStandConfirmado extends CandidaturaEstado implements Serializable {
    ...
    public boolean valida(Candidatura candidatura) {
        ...
        if (state instanceof CandidaturaStandAtribuido) {
            return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setCandidaturaStandConfirmado(Candidatura candidatura) {

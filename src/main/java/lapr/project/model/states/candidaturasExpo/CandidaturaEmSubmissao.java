 ...
 */
@XmlRootElement
public class CandidaturaEmSubmissao extends CandidaturaEstado implements Serializable {
    ...
    public boolean valida(Candidatura candidatura) {
        ...
        if (state instanceof CandidaturaCriada) {
            return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setCandidaturaEmSubmissao(Candidatura candidatura) {

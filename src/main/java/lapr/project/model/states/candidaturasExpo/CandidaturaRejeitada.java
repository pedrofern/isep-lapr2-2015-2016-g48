 ...
 */
@XmlRootElement
public class CandidaturaRejeitada extends CandidaturaEstado implements Serializable {
    ...
    public boolean valida(Candidatura candidatura) {
        ...
        if (state instanceof CandidaturaAvaliada) {
            return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setCandidaturaRejeitada(Candidatura candidatura) {

 ...
 */
@XmlRootElement
public class CandidaturaTerminada extends CandidaturaEstado implements Serializable {
    ...
    public boolean valida(Candidatura candidatura) {
        ...
        if (state instanceof CandidaturaStandConfirmado) {
            return true;
        }
        if (state instanceof CandidaturaRejeitada) {
            return true;
        }
        if (state instanceof CandidaturaNaoAvaliada) {
            return true;
        }
        if (state instanceof CandidaturaRetirada) {
            return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setCandidaturaStandAtribuido(Candidatura candidatura) {

 ...
 */
@XmlRootElement
public class CandidaturaEmAvaliacao extends CandidaturaEstado implements Serializable {
    ...
    public boolean valida(Candidatura candidatura) {
        ...
        if (state instanceof CandidaturaEmAtribuicao) {
            return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setCandidaturaEmAvaliacao(Candidatura candidatura) {

 ...
 */
@XmlRootElement
public class CandidaturaEmAtribuicao extends CandidaturaEstado implements Serializable {
    ...
    public boolean valida(Candidatura candidatura) {
        ...
        if (state instanceof CandidaturaEmSubmissao) {
            return true;
        }
        return false;
    }
     ...
     */
    @Override
    public boolean setCandidaturaEmAtribuicao(Candidatura candidatura) {
